...
const NavLink = ({href, children}) => {
    return <Link className="flex items-center gap-x-2 py-2 px-4 text-white rounded-lg hover:bg-gray-100 hover:text-black" href={href}>{children}</Link>
}
    ...
    return (
        <div className="space-y-6 text-sm">
            ...
            <div>
                ...
                <NavLink href="/">
                    <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="currentColor" className="bi bi-reply-fill" viewBox="0 0 16 16">
